        ...
        <div class="main-container">
            <ul v-if="stocks.length" class="main">
                <li v-for="stock in stocks" class="card main-bar" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title mt-4 mb-4">{{ stock.stockName }}</h5>
                        <h6 class="card-subtitle text-body-secondary  mt-0 mb-1">
                            <span>전날 대비&nbsp;&nbsp;&nbsp;</span>
                            <span :class="{'text-red': stock.text === '상승', 'text-blue': stock.text === '하락'}">
                                {{ stock.compareToPreviousClosePrice }}원 
                                <span v-if="stock.text === '상승'">▲</span>
                                <span v-else-if="stock.text === '하락'">▼</span>
                            </span>
                        </h6>
